...
*/
    ...
    private ObservableList<Offre> getVolsList() {
        ...
        try {
            ...
            Offre offre;
            while(rs.next()) {
                offre = new Offre(rs.getString("idoffre"),rs.getString("id_reservation"),rs.getDate("date_validite"),rs.getString("taux_de_remise"),rs.getString("description"),rs.getString("Path_image"),rs.getString("Path_video"),rs.getString("Titre"),rs.getInt("prix"));
                offreList.add(offre);
