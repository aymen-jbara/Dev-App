...
public class Offre {
    ...
    public Offre(String idoffre, String id_reservation, Date date_validite, String taux_de_remise, String description, String path_image, String path_video, String titre,int prix) {
