...
////affichage dns le table
    ...
    private void update() {
        ...
        String query = "UPDATE hotel SET id=" + Id_hotel_bad.getText() + ",nom='" + Nom_hotel_bad.getText() + "',etoile=" + Etoilet_hotel_bad.getText() + ",hebergement='" + Heb_hotel_bad.getText() + "',lieu='" + Lieu_Hotel_bad.getText() + "',ch_In=" + ch_sin.getText()+ " WHERE id ='" + H.getId() + "' ";
        executeQuery(query);
        TrayNotification tray = new TrayNotification();
        AnimationType type = AnimationType.POPUP;
        tray.setAnimationType(type);
