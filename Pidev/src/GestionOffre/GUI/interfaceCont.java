...
*/
    ...
    String btnAdd(ActionEvent event) {
        ...
        //showOffres();
        try{
            String st="insert into offre (idoffre,id_reservation,Titre,date_validite,taux_de_remise,description,Path_image,Path_video,prix) values(?,?,?,?,?,?,?,?,?)";
    ...
    void btnEdit(ActionEvent event) {
        ...
        //showOffres();
        try{
            String st="UPDATE offre set Titre=?,date_validite=?,taux_de_remise=?,description=?,Path_image=?,Path_video=?,prix=? WHERE idoffre=?";
            preparedStatement=(PreparedStatement)connection.prepareStatement(st);
            ...
            preparedStatement.setInt(7, Integer.parseInt(String.valueOf(Prix)));

            preparedStatement.setString(8,offre.getIdoffre());
    ...
    private ObservableList<Offre> getVolsList() {
        ...
        try {
            ...
            Offre offre;
            while(rs.next()) {
                offre = new Offre(rs.getString("idoffre"),rs.getString("id_reservation"),rs.getDate("date_validite"),rs.getString("taux_de_remise"),rs.getString("description"),rs.getString("Path_image"),rs.getString("Path_video"),rs.getString("Titre"));
                offreList.add(offre);
