...
public class FXMLEventsController implements Initializable {
    ...
    void btnweather(ActionEvent event) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/sample/Omar.WeatherAPI/primary.fxml"));
    ...
    void btnrun(ActionEvent event) throws Exception {
        ...
        Stage primaryStage = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("/sample/Omar.ApiSmS/smsapi.fxml"));
