...
public class G_Hotel implements Initializable {
    ...
    private void insertRecord() {
        String query = "INSERT INTO hotel VALUES('" + random_id() + "','" + Nom_hotel_bad.getText() + "'," + Etoilet_hotel_bad.getText() + ",'" + Heb_hotel_bad.getText() + "','" + Lieu_Hotel_bad.getText() + "','" + pathImg + "','" + pathVideo + "','" + chambre +"',"+ch_sin.getText()+")";
        executeQuery(query);
    ...
    private void update() {
        ...
        String query = "UPDATE hotel SET id=" + Id_hotel_bad.getText() + ",nom='" + Nom_hotel_bad.getText() + "',etoile=" + Etoilet_hotel_bad.getText() + ",hebergement='" + Heb_hotel_bad.getText() + "',lieu='" + Lieu_Hotel_bad.getText() + "',ch_In=" + ch_sin.getText() +/* ",ch_db=" + ch_double.getText() + ",ch_tr=" + ch_triple.getText() +*/ " WHERE id = " + H.getId() + " ";
        executeQuery(query);
        TrayNotification tray = new TrayNotification();
        AnimationType type = AnimationType.POPUP;
        tray.setAnimationType(type);
    ...
    void PDF(ActionEvent event) throws DocumentException {
        ...
        try {
            ...
            Paragraph p = new Paragraph("les hotels sont ",f);
